...
class ContactMailer
{
     ...
     * @var string
     */
    private static $emailFrom = 'den.obraz@yandex.ru';
    /**
     * E-mail получателя
     * @var string
     */
    private static $emailTo = 'DPreobrazhensky@alteris.ru';
     ...
     * @return boolean
     */
    public static function send($company, $name, $email, $phone, $message)
    {
        ...
        $mailer->isSMTP();
        // Устанавливает хост почтового сервера (Mail.ru: smtp.mail.ru, Google: smtp.gmail.com, smtp.yandex.ru)
